...
void wireclaw_setup() {   /* VENDOR EDIT: renamed from setup() so the Gentis firmware entry (src/main.cpp) owns the Arduino setup(). See wireclaw/VENDOR.md. */
    Serial.begin(115200);
    delay(5000);
...
void wireclaw_loop() {   /* VENDOR EDIT: renamed from loop() so the Gentis firmware entry (src/main.cpp) owns the Arduino loop(). See wireclaw/VENDOR.md. */
